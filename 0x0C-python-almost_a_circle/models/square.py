...
class Square(Rectangle):
    ...
    Attributes:
        ...
        x (int, optional): The x-coordinate of the square's top-left corner.
                           Default is 0.
        y (int, optional): The y-coordinate of the square's top-left corner.
                           Default is 0.
        id (int or None, optional): An identifier for the square.
                                    Default is None.
    ...
    Inherits:
        Rectangle: This class inherits properties and methods from
        the Rectangle class.
    """
    ...
    def update(self, *args, **kwargs):
        ...
        arguments, the order of arguments should be (id, size, x, y).

        Parameters:
        - args (*args): Positional arguments for updating object
                        attributes.
                        The order should be (id, size, x, y).

        - kwargs (**kwargs): Keyword arguments for updating object
                                attributes.
                                Supported keywords are 'id', 'size', 'x',
                                and 'y'.

        Note:
        - When using both positional and keyword arguments, positional
            arguments take precedence over keyword arguments for attribute
            updates.
